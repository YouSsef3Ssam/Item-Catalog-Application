...
def showCatalog():
    ...
    if 'username' not in login_session:  # make sure user has logined
        return render_template('catalogforanonymous.html', categories=categories,
                               items=items)
    else:  # if user logined, able to access create a new item
        return render_template('catalogforauthorize.html', categories=categories,
                               items=items)
...
def showItem(categories_id, items_id):
    ...
    if 'username' not in login_session or \
        ...
        return render_template('itemforauthorize.html', categories=categories, items=items)
